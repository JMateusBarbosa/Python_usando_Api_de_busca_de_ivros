...
''' auternativa para decodificação de códigos de barras pela imagem
...
def manual_entry():
    ...
    entry_label = ttk.Label(manual_entry_window, text="Digite o código de barras:")
    entry_label.pack()
...
def process_barcode(barcode_number):
    try:
        ...
        if 'items' in response_data:
            ...
            # Extrair informações ISBN-13 e ISBN-10 (se disponíveis)
            isbn_13 = None
            isbn_10 = None
            ...
            # Tentar extrair o CDD das categorias ou outra informação disponível
...
scan_button = ttk.Button(root, text="Digitalizar Câmerera", command=scan_camera)
scan_button.pack()
