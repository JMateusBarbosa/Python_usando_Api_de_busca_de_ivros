...
def process_barcode(barcode_number):
    try:
        ...
        if 'items' in response_data:
            ...
            isbn_13 = book_data.get('industryIdentifiers', [])[0].get('identifier', 'Informação não disponível')
            isbn_10 = book_data.get('industryIdentifiers', [])[1].get('identifier', 'Informação não disponível')
